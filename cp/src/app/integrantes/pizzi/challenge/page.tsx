...
export default function Pizzinato() {
    ...
    useEffect(() => {
        const chamadaApi = async () => {
            try {
                const response = await fetch("http://localhost:3000/api/felipe-pizzinato/challenge");
    ...
    const handleDelete = async (id: number) => {
        try {
            const response = await fetch(`http://localhost:3000/api/felipe-pizzinato/challenge/${id}`, {
                method: 'DELETE',
            });
    ...
    return (
        <div className="container_trabalhos">
            <h1>Challenge - Felipe Pizzinato</h1>
                    ...
                    <div>
                        ...
                        <div className="texto_icones_caixa">
                            ...
                            <div className="icones_caixa">
                                <Link href={`/integrantes/pizzi/challenge/challenge/${trabalho.id}`} className="botoes_trabalhos"><Image src={iconeEditar} alt="Icone de Editar" className="icones"/></Link>
            ...
            <div className="caixa_adicionar">
                <Link href="/integrantes/pizzi/challenge/cad-challenge" className="links_adiconar"><Image src={iconeAdicionar} alt="Icone de Adicionar" className="icone_adicionar"/></Link>
            </div>
        </div>
    );
}
