...
export default function Pizzinato() {
    ...
    const handleDelete = async (id: number) => {
        try {
            const response = await fetch(`http://localhost:3000/api/felipe-pizzinato/checkpoint/${id}`, {
                method: 'DELETE',
            });
    ...
    return (
        <div className="container_trabalhos">
            <h1>CheckPoints - Felipe Pizzinato</h1>
                    ...
                    <div>
                        ...
                        <div className="texto_icones_caixa">
                            ...
                            <div className="icones_caixa">
                                <Link href={`/integrantes/pizzi/cp/cp/${trabalho.id}`} className="botoes_trabalhos"><Image src={iconeEditar} alt="Icone de Editar" className="icones"/></Link>
            ...
            <div className="caixa_adicionar">
                <Link href="/integrantes/pizzi/cp/cad-cp" className="links_adiconar"><Image src={iconeAdicionar} alt="Icone de Adicionar" className="icone_adicionar"/></Link>
            </div>
        </div>
    );
}
