            ...
            <div className="integrantes">
                ...
                <nav>
                    <ul>
                        ...
                        <li><Image src={Github} width={182} height={176} alt="Foto Felipe Pizzinato" className="foto_integrante"/><Link href="/integrantes/pizzi/gs" className="links_integrantes">Felipe Pizzinato</Link></li>
