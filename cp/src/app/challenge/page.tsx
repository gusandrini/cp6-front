    ...
    return (
        <div className="container_conteudo">
            ...
            <div className="integrantes">
                ...
                <nav>
                    <ul>
                        <li><Image src={fotoEduarda} alt="Foto Eduarda" className="foto_integrante"/><Link href="/integrantes/duda/challenge" className="links_integrantes">Eduarda Tiemi</Link></li>
                        <li><Image src={fotoFelipePizzinato} alt="Foto Felipe Pizzinato" className="foto_integrante"/><Link href="/integrantes/pizzi/challenge" className="links_integrantes">Felipe Pizzinato</Link></li>
                        <li><Image src={fotoFelipeSora} alt="Foto Felipe Sora" className="foto_integrante"/><Link href="/integrantes/sora/challenge" className="links_integrantes">Felipe Sora</Link></li>
                        <li><Image src={fotoGustavo} alt="Foto Gustavo" className="foto_integrante"/><Link href="/integrantes/gu/challenge" className="links_integrantes">Gustavo Sandrini</Link></li>
                    </ul>
                </nav>
            </div>
        </div>
